...
public class DevpostTextBehaviour : MonoBehaviour {
	// Use this for initialization
	private TextMesh contentText;
	private int counter;
	private static string[] CONTENTS = {"Great hackathon!", "Wow!"};
	...
	void Start () {
		contentText = GameObject.Find("DevpostText").GetComponent<TextMesh>();
		counter = 0;
	}
